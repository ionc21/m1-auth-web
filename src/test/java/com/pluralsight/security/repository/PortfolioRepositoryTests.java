...
@RunWith(SpringRunner.class) @DataMongoTest public class PortfolioRepositoryTests {

    @Autowired private PortfolioRepository portfolioRepository;
    @Autowired private CryptoCurrencyRepository cryptoRepository;
    ...
    @Before public void setup() {
        ...
        transactions.add(new Transaction(litecoin, BUY, new BigDecimal(20.1), new BigDecimal(13000.00),
                System.currentTimeMillis()));
        transactions.add(new Transaction(litecoin, BUY, new BigDecimal(200.1), new BigDecimal(13000.00),
                System.currentTimeMillis()));
        portfolioRepository.save(new Portfolio("snakamoto", transactions));
    }

    @Test public void findPortfolioByUsername() {
        //Given
    ...
    @Test public void testDeleteTransactionFromPortfolio() {
        Portfolio portfolio = portfolioRepository.findByUsername("snakamoto");
