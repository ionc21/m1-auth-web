...
@RunWith(SpringRunner.class) @DataMongoTest public class SupportQueryRepositoryTest {

    @Autowired private SupportQueryRepository supportRepository;
    ...
    @Test public void testRetrieveSupportQuery() {
    ...
    @Test public void testUpdateSUpportQueryWithNewPost() {
